//array to store zodiac signs names
var signs = ["Aries", "Taurus", "Gemini", "Cancer", "Leo", "Virgo", "Libra", "Scorpio", "Sagittarius", "Capricorn", "Aquarius", "Pisces"];
//array to store zodiac sign images
...
//selecting html elements to display zodiac signs and images
 var signElement = document.getElementById("sign");
 var signImage = document.getElementById("signImage");
//function to get date from user input and put it in date-month format
 function getDate() {
