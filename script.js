//arrays to store all zodiac signs and corrisponding images  
...
//get sign and sign image html elements
 var signElement = document.getElementById("sign");
 var signImage = document.getElementById("signImage");

//fuction to get inputed date form html form and find matching zodiac sign
 function getDate() {
   //get date from html form and parse it into month/day format
